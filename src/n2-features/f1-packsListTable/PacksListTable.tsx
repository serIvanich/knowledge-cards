            ...
            {cardPacks
                ...
                .map((p, i) => {
                    ...
                    return <tr key={i} className={s.tableRow}>
                        <td className={s.tableCell}><NavLink to={routes.mainPacks}>{p.name}</NavLink></td>
                        ...
                        <td className={s.tableCell}>
                            <div className={s.buttonInTableContainer}>
                                <button className={s.buttonInTable} disabled={p.user_id !== profileId}
                                        onClick={() => deletePack(p._id)}>delete
                                </button>
                                <button className={s.buttonInTable} disabled={p.user_id !== profileId}
                                        onClick={() => updatePack(p._id)}>edit
                                </button>
                                <button className={s.buttonInTable}>learn</button>
                            </div>
                        </td>
                    </tr>
                })}
